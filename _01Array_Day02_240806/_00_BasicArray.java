...
public class _00_BasicArray {
	public static void main(String[] args) {
		 ...
		 * 		 같은 자료형을 연속적으로 저장
		 * 		(나중에는 다른 다료형도 저장 할 수 있는 것 배울예정)
		 * 		고정길이 - 사용하지 않은 index가 있을 수도 있고 , 길이가 짧아서 데이터를 다 저장하기 못할 수도 있음, 단 속도는 빠름.
		 * 공부할때 : 배열의 빌이, 베열의 인텍스 기억하지!
		 * 
		 * */ 
		// 배열 선언문
		...
		lotto[3] = lotto[1] + 20;	// 3번 인덱스가 없음.
									// 에외발행 : ArrayIndexOutOfBoundsException
	}
}
